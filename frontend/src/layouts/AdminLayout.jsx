      ...
      <aside style={s.sidebar}>
        <div style={s.brand}>
          ...
          <div>
            ...
            <div style={s.brandRole}>Admin Panel</div>
          </div>
        </div>
        <nav style={s.nav}>
...
const s = {
  ...
  brandRole: { fontSize: '0.62rem', color: '#f97316', marginTop: '1px', fontWeight: '600' },
  nav:       { flex: 1, padding: '1.25rem 0.75rem', overflowY: 'auto' },
  ...
  avatar:    { width: '34px', height: '34px', background: 'linear-gradient(135deg,#f97316,#fb923c)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: '700', fontSize: '0.82rem', flexShrink: 0 },
