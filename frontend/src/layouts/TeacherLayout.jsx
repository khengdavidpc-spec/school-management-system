      ...
      <aside style={s.sidebar}>
        <div style={s.brand}>
          ...
          <div>
            ...
            <div style={s.brandRole}>Teacher Portal</div>
          </div>
        </div>
        <nav style={s.nav}>
        ...
        <div style={s.bottom}>
          <div style={s.divider}/>
          <div style={s.userBox}>
            <div style={{ ...s.avatar, background: 'linear-gradient(135deg,#8b5cf6,#a78bfa)' }}>{user.name?.charAt(0)?.toUpperCase()}</div>
...
const s = {
  ...
  brandIcon: { width: '40px', height: '40px', background: 'linear-gradient(135deg,#8b5cf6,#a78bfa)', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.3rem', flexShrink: 0 },
  brandName: { fontWeight: '800', fontSize: '0.9rem', color: '#fff' },
  brandRole: { fontSize: '0.62rem', color: '#a78bfa', marginTop: '1px', fontWeight: '600' },
  ...
  navActive: { background: 'rgba(139,92,246,0.15)', color: '#a78bfa', fontWeight: '600' },
