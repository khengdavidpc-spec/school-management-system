...
const empty = { firstName: '', lastName: '', email: '', phone: '', subject: '' };
...
export default function TeachersPage() {
  ...
  const handleEdit = (teacher) => {
    setForm({ firstName: teacher.firstName, lastName: teacher.lastName, email: teacher.email, phone: teacher.phone || '', subject: teacher.subject });
      ...
      <div style={styles.container}>
        ...
        {showForm && (
          <div style={styles.formCard}>
            <h3 style={{ margin: '0 0 1rem' }}>{editId ? 'Edit Teacher' : 'Add Teacher'}</h3>
            ...
            <form onSubmit={handleSubmit} style={styles.form}>
              ...
              <input style={styles.input} placeholder="Subject"    value={form.subject}   onChange={(e) => setForm({ ...form, subject: e.target.value })}    required />
